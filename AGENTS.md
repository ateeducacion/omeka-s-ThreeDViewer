...
Read [three-dimensional-media](.agents/skills/three-dimensional-media/SKILL.md) when you need to: change 3D renderer selection, model formats, viewer settings, or asset loading.
